...
me = DigitalCraftsman()
me.craft_solutions()  # The adventure begins!
```
...
<table align="center">
  ...
  <tr>
    <td align="center" width="120" style="padding: 15px; border-radius: 12px; background: #f7f9fc; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
      <a href="javascript:void(0)">
        <img src="https://skillicons.dev/icons?i=fastapi" alt="FastAPI" width="70" height="70"/>
        <br>
        <span style="font-weight: bold; color: #009688;">FastAPI</span>
      </a>
    </td>
    <td align="center" width="120" style="padding: 15px; border-radius: 12px; background: #f7f9fc; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
      <a href="javascript:void(0)">
...
<div align="center">
  <table>
    <tr>
      <td width="50%">
        <h3 align="center">🎓 My all Projects</h3>
        <p align="center">
          <a href="https://vercel.com/pradeeps-projects-2a3a96e2" target="_blank">
      ...
      <td width="50%">
        ...
        <p align="center">
          ...
          <p align="center">
            ...
            <br><br>
            <a href="https://tailwind-profile-ashy.vercel.app/" target="_blank">
